 ...
 * ExpiryQueue 跟踪固定持续时间桶中的元素。
 * SessionTrackerImpl 使用它来终止会话和 NIOServerCnxnFactory 以终止连接。
 */
public class ExpiryQueue<E> {
    ...
    /**
     *
     * @param expirationInterval  表示过期因子
     */
     ...
     * 添加或更新队列中元素的过期时间, 将超时舍入到此队列使用的到期间隔 bucketed。
